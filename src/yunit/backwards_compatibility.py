...
if sys.version_info >= (3, 8):
    from typing import Protocol, Literal, TYPE_CHECKING  # See note below on
    #                                                    # `TYPE_CHECKING`.
    from math import prod

else:
    from typing_extensions import Protocol, Literal, TYPE_CHECKING  # Backports of new
    #                                                          # objects from `typing`.
...
# type annotations.
# See [PEP 563](https://www.python.org/dev/peps/pep-0563/#runtime-annotation-resolution-
# and-type-checking).
